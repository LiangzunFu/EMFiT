...
from I3D_ViT_model import I3D_ViT
...
def main(args):
    ...
    net = I3D_ViT(15, pre_trained_weight_path).to(device)
...
if __name__ == '__main__':
    ...
    parse.add_argument('--txt_path', type=str, default="/path/to/output_file_I3D_ViT_multi_gpu_new_dataset.txt")
    # the path to save every class testing accuracy
    parse.add_argument('--class_txt_path', type=str,
                       default="/path/to/output_file_I3D_ViT_multi_gpu_confusion_matrix_new_dataset.txt")
    # the path to save the .pth weight file
    parse.add_argument('--save_path', type=str, default='/path/to/weights_I3D_ViT_multi_gpu_new_dataset.pth')
    # the path to save the last epoch .pth weight file
    parse.add_argument('--save_path_last', type=str,
                       default='/path/to/weights_I3D_ViT_multi_gpu_last_new_dataset.pth')
    ...
    torchrun --nproc_per_node=2 /path/to/your/train_I3D_ViT_multi_GPU.py

...
from pythonProject.I3D_ViT.I3D_ViT_model import I3D_ViT
...
def main():
    ...
    model = I3D_ViT(num_classes=15, pre_trained_weight=None).to(device)
    ...
    model.eval()
    test_dataset = Embryo_Dataset_Time_Lapse_I3D(folder_path, video_num=(425, 524),

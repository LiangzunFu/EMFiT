...
if __name__ == '__main__':
    ...
    parse.add_argument('--txt_path', type=str,
                       default="/path/to/output_file_ResNet50_gpus_new_dataset.txt")
    # the path to save every class testing accuracy
    parse.add_argument('--class_txt_path', type=str,
                       default="/path/to/output_file_ResNet50_gpus_confusion_matrix_new_dataset.txt")
    # the path to save the .pth weight file
    parse.add_argument('--save_path', type=str,
                       default='/path/to/weights_ResNet50_gpus_new_dataset.pth')
    # the path to save the last epoch .pth weight file
    parse.add_argument('--save_path_last', type=str,
                       default='/path/to/weights_ResNet50_gpus_last_new_dataset.pth')
    ...
    torchrun --nproc_per_node=2 /path/to/your/train_resnet_multi_GPU.py
